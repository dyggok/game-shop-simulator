...
public class PCWExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(PCWDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new PCWStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static PCWDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static PCWDateTimeConverter dateTimeConverter = new PCWStandardDateTimeConverter();

    public PCWExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public PCWExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new PCWMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=PCWHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,PCWExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=PCWHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
