...
public class PCWKPSPublicSoap
{
    ...
    public PCWKPSPublicSoap(){}

    public PCWKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public PCWKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        PCWExtendedSoapSerializationEnvelope envelope= new PCWExtendedSoapSerializationEnvelope(PCWExtendedSoapSerializationEnvelope.VER11);
